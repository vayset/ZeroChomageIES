...
struct Strings {
    ...
    static let passwordRespectRulesTitle = "passwordRespectRulesTitle".localized
    static let passwordRespectRulesOne = "passwordRespectRulesOne".localized
    static let passwordRespectRulesTwo = "passwordRespectRulesTwo".localized
